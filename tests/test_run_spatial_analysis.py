...
class TestApplyMushroomFilter:
    ...
    def test_filter_excludes_shelf_fungi(
        self, sample_mushroom_df: pd.DataFrame
    ) -> None:
    ...
    def test_filter_excludes_crust_fungi(
        self, sample_mushroom_df: pd.DataFrame
    ) -> None:
    ...
    def test_filter_excludes_slime_molds(
        self, sample_mushroom_df: pd.DataFrame
    ) -> None:
    ...
    def test_filter_includes_whitelisted_species(
        self, sample_mushroom_df: pd.DataFrame
    ) -> None:
    ...
    def test_filter_excludes_by_caption_keyword(
        self, sample_mushroom_df: pd.DataFrame
    ) -> None:
        """Test that captions with excluded keywords are filtered."""
        test_filter = MushroomFilter(
            exclude_caption_keywords=["turkey tail", "resupinate"]
        )
        result = apply_mushroom_filter(sample_mushroom_df, mushroom_filter=test_filter)
...
class TestErrorHandling:
    ...
    def test_filter_with_custom_filter_object(
        self, sample_mushroom_df: pd.DataFrame
    ) -> None:
        """Test applying filter with custom MushroomFilter object."""
        custom_filter = MushroomFilter(exclude_genera=["Trametes"])
        result = apply_mushroom_filter(
            sample_mushroom_df, mushroom_filter=custom_filter
        )
